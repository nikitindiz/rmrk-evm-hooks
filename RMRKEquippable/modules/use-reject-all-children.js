...
export const useRejectAllChildren = ({ tokenId, maxRejections }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKEquippableImpl, functionName: 'rejectAllChildren', args: [tokenId, maxRejections] }, rest));
