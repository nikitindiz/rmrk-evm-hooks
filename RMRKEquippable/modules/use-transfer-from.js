...
export const useTransferFrom = ({ from, to, tokenId }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKEquippableImpl, functionName: 'transferFrom', args: [from, to, tokenId] }, rest));
