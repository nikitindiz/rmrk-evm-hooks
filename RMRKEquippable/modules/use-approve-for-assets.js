...
export const useApproveForAssets = ({ to, tokenId }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKEquippableImpl, functionName: 'approveForAssets', args: [to, tokenId] }, rest));
