...
export const useAcceptAsset = ({ tokenId, index, assetId }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKEquippableImpl, functionName: 'acceptAsset', args: [tokenId, index, assetId] }, rest));
