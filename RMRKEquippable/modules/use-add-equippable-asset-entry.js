...
export const useAddEquippableAssetEntry = ({ equippableGroupId, catalogAddress, metadataURI, partIds }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKEquippableImpl, functionName: 'addEquippableAssetEntry', args: [equippableGroupId, catalogAddress, metadataURI, partIds] }, rest));
...
//# sourceMappingURL=use-add-equippable-asset-entry.js.map