...
export const useUpdateRoyaltyRecipient = ({ newRoyaltyRecipient }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKEquippableImpl, functionName: 'updateRoyaltyRecipient', args: [newRoyaltyRecipient] }, rest));
