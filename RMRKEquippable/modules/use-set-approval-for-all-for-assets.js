...
export const useSetApprovalForAllForAssets = ({ operator, approved }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKEquippableImpl, functionName: 'setApprovalForAllForAssets', args: [operator, approved] }, rest));
