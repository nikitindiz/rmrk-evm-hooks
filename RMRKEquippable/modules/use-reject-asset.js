...
export const useRejectAsset = ({ tokenId, index, assetId }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKEquippableImpl, functionName: 'rejectAsset', args: [tokenId, index, assetId] }, rest));
