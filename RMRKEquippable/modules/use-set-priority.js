...
export const useSetPriority = ({ tokenId, priorities }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKEquippableImpl, functionName: 'setPriority', args: [tokenId, priorities] }, rest));
