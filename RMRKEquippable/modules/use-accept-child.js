...
export const useAcceptChild = ({ parentId, childIndex, childAddress, childId }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKEquippableImpl, functionName: 'acceptChild', args: [parentId, childIndex, childAddress, childId] }, rest));
