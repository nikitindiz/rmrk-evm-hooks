...
export const useRejectAllAssets = ({ tokenId, maxRejections }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKEquippableImpl, functionName: 'rejectAllAssets', args: [tokenId, maxRejections] }, rest));
