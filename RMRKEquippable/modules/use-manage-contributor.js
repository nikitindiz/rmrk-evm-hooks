...
export const useManageContributor = ({ contributor, grantRole }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKEquippableImpl, functionName: 'manageContributor', args: [contributor, grantRole] }, rest));
