...
export const useAddAssetToToken = ({ tokenId, assetId, replacesAssetWithId }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKEquippableImpl, functionName: 'addAssetToToken', args: [tokenId, assetId, replacesAssetWithId] }, rest));
