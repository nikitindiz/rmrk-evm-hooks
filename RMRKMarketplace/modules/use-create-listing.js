...
const availableCreateListingNetworks = {
    'moonbase-alpha': '0x3A854CFc9B912B0219146C4B829cD8Ce43695743',
};
export const useCreateListing = ({ _params }, _a) => {
    var { chainId, network, signer } = _a, rest = __rest(_a, ["chainId", "network", "signer"]);
    const [receipt, setReceipt] = useState();
    const [waitError, setWaitError] = useState();
    const [isWaiting, setIsWaiting] = useState();
    const prepare = usePrepareContractWrite(Object.assign({ address: availableCreateListingNetworks[network], chainId, abi: RMRKMarketplace, functionName: 'createListing', args: [_params] }, rest));
    ...
    const contract = getContract({
        address: availableCreateListingNetworks[network],
        abi: RMRKMarketplace,
...
//# sourceMappingURL=use-create-listing.js.map