...
const availableOnERC1155BatchReceivedNetworks = {
    'moonbase-alpha': '0x3A854CFc9B912B0219146C4B829cD8Ce43695743',
};
export const useOnERC1155BatchReceived = (args, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: availableOnERC1155BatchReceivedNetworks[network], chainId, abi: RMRKMarketplace, functionName: 'onERC1155BatchReceived', args }, rest));
    ...
    const contract = getContract({
        address: availableOnERC1155BatchReceivedNetworks[network],
        abi: RMRKMarketplace,
...
//# sourceMappingURL=use-on-erc1155-batch-received.js.map