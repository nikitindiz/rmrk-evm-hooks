...
const availableSettleAuctionNetworks = {
    'moonbase-alpha': '0x3A854CFc9B912B0219146C4B829cD8Ce43695743',
};
export const useSettleAuction = ({ _listingId }, _a) => {
    var { chainId, network, signer } = _a, rest = __rest(_a, ["chainId", "network", "signer"]);
    const [receipt, setReceipt] = useState();
    const [waitError, setWaitError] = useState();
    const [isWaiting, setIsWaiting] = useState();
    const prepare = usePrepareContractWrite(Object.assign({ address: availableSettleAuctionNetworks[network], chainId, abi: RMRKMarketplace, functionName: 'settleAuction', args: [_listingId] }, rest));
    ...
    const contract = getContract({
        address: availableSettleAuctionNetworks[network],
        abi: RMRKMarketplace,
...
//# sourceMappingURL=use-settle-auction.js.map