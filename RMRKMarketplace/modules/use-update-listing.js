...
const availableUpdateListingNetworks = {
    'moonbase-alpha': '0x3A854CFc9B912B0219146C4B829cD8Ce43695743',
};
export const useUpdateListing = ({ _listingId, _quantityToList, _buyoutPricePerToken, _currencyToAccept, _startTime, _secondsUntilEndTime, _gbm, }, _a) => {
    var { chainId, network, signer } = _a, rest = __rest(_a, ["chainId", "network", "signer"]);
    const [receipt, setReceipt] = useState();
    const [waitError, setWaitError] = useState();
    const [isWaiting, setIsWaiting] = useState();
    const prepare = usePrepareContractWrite(Object.assign({ address: availableUpdateListingNetworks[network], chainId, abi: RMRKMarketplace, functionName: 'updateListing', args: [
            _listingId,
            _quantityToList,
    ...
    const contract = getContract({
        address: availableUpdateListingNetworks[network],
        abi: RMRKMarketplace,
...
//# sourceMappingURL=use-update-listing.js.map