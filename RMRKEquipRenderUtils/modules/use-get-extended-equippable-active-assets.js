...
const availableGetExtendedEquippableActiveAssetsNetworks = {
    'moonbase-alpha': '0x5b1501BC44340050dBAe46387f8e0029CB285749',
    'zksync-testnet': '0x97D515Ce10B75C17cF9f87f06b68eAB769b10eD9',
};
const createMapper = ({ chainId, contractAddress, }) => function mapGetExtendedEquippableActiveAssetsArgs({ target, tokenId, }) {
    return {
...
export const useGetExtendedEquippableActiveAssets = (args, _a) => {
    ...
    return useContractReads(Object.assign({ contracts: args.map(createMapper({
            chainId,
            contractAddress: availableGetExtendedEquippableActiveAssetsNetworks[network],
        })), enabled: !skip }, rest));
};
//# sourceMappingURL=use-get-extended-equippable-active-assets.js.map