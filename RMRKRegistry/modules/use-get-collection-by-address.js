...
const availableGetCollectionByAddressNetworks = {
    'moonbase-alpha': '0x7a1785a89aEbdD16F23731D4613a5e746eB8e495',
    'zksync-testnet': '0xC60c3F9dC842dc413df360f42f95CC708e240616',
};
const createMapper = ({ chainId, contractAddress, }) => function mapGetCollectionByAddressArgs({ _collection }) {
    return {
...
export const useGetCollectionByAddress = (args, _a) => {
    ...
    return useContractReads(Object.assign({ contracts: args.map(createMapper({
            chainId,
            contractAddress: availableGetCollectionByAddressNetworks[network],
        })), enabled: !skip }, rest));
};
//# sourceMappingURL=use-get-collection-by-address.js.map