...
const availableRemoveAdminNetworks = {
    'moonbase-alpha': '0x7a1785a89aEbdD16F23731D4613a5e746eB8e495',
    'zksync-testnet': '0xC60c3F9dC842dc413df360f42f95CC708e240616',
};
export const useRemoveAdmin = ({ admin, adminIndex }, _a) => {
    var { chainId, network, signer } = _a, rest = __rest(_a, ["chainId", "network", "signer"]);
    const [receipt, setReceipt] = useState();
    const [waitError, setWaitError] = useState();
    const [isWaiting, setIsWaiting] = useState();
    const prepare = usePrepareContractWrite(Object.assign({ address: availableRemoveAdminNetworks[network], chainId, abi: RMRKRegistry, functionName: 'removeAdmin', args: [admin, adminIndex] }, rest));
    ...
    const contract = getContract({
        address: availableRemoveAdminNetworks[network],
        abi: RMRKRegistry,
...
//# sourceMappingURL=use-remove-admin.js.map