...
const availableAddAcceptedCurrencyNetworks = {
    'moonbase-alpha': '0x7a1785a89aEbdD16F23731D4613a5e746eB8e495',
    'zksync-testnet': '0xC60c3F9dC842dc413df360f42f95CC708e240616',
};
export const useAddAcceptedCurrency = ({ currency }, _a) => {
    var { chainId, network, signer } = _a, rest = __rest(_a, ["chainId", "network", "signer"]);
    const [receipt, setReceipt] = useState();
    const [waitError, setWaitError] = useState();
    const [isWaiting, setIsWaiting] = useState();
    const prepare = usePrepareContractWrite(Object.assign({ address: availableAddAcceptedCurrencyNetworks[network], chainId, abi: RMRKRegistry, functionName: 'addAcceptedCurrency', args: [currency] }, rest));
    ...
    const contract = getContract({
        address: availableAddAcceptedCurrencyNetworks[network],
        abi: RMRKRegistry,
...
//# sourceMappingURL=use-add-accepted-currency.js.map