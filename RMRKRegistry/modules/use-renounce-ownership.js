...
const availableRenounceOwnershipNetworks = {
    'moonbase-alpha': '0x7a1785a89aEbdD16F23731D4613a5e746eB8e495',
    'zksync-testnet': '0xC60c3F9dC842dc413df360f42f95CC708e240616',
};
export const useRenounceOwnership = (_a) => {
    var { chainId, network, signer } = _a, rest = __rest(_a, ["chainId", "network", "signer"]);
    const [receipt, setReceipt] = useState();
    const [waitError, setWaitError] = useState();
    const [isWaiting, setIsWaiting] = useState();
    const prepare = usePrepareContractWrite(Object.assign({ address: availableRenounceOwnershipNetworks[network], chainId, abi: RMRKRegistry, functionName: 'renounceOwnership' }, rest));
    ...
    const contract = getContract({
        address: availableRenounceOwnershipNetworks[network],
        abi: RMRKRegistry,
...
//# sourceMappingURL=use-renounce-ownership.js.map