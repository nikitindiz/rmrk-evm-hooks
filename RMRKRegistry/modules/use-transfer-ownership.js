...
const availableTransferOwnershipNetworks = {
...
export const useTransferOwnership = ({ newOwner }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: availableTransferOwnershipNetworks[network], chainId, abi: RMRKRegistry, functionName: 'transferOwnership', args: [newOwner] }, rest));
    ...
    const contract = getContract({
        address: availableTransferOwnershipNetworks[network],
        abi: RMRKRegistry,
