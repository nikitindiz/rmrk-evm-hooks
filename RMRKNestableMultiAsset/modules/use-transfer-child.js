...
export const useTransferChild = ({ tokenId, to, destinationId, childIndex, childAddress, childId, isPending, data, }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKNestableMultiAssetImpl, functionName: 'transferChild', args: [tokenId, to, destinationId, childIndex, childAddress, childId, isPending, data] }, rest));
