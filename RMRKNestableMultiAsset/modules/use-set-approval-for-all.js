...
export const useSetApprovalForAll = ({ operator, approved }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKNestableMultiAssetImpl, functionName: 'setApprovalForAll', args: [operator, approved] }, rest));
