...
export const useNestTransferFrom = ({ from, to, tokenId, destinationId, data }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKNestableMultiAssetImpl, functionName: 'nestTransferFrom', args: [from, to, tokenId, destinationId, data] }, rest));
