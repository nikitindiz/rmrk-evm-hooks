...
export const useRejectAllChildren = ({ tokenId, maxRejections }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKNestableMultiAssetImpl, functionName: 'rejectAllChildren', args: [tokenId, maxRejections] }, rest));
