...
export const useGetRoyaltyPercentage = (_a) => {
    ...
    return useContractRead(Object.assign({ address: contractAddress, abi: RMRKNestableMultiAssetImpl, functionName: 'getRoyaltyPercentage', chainId, enabled: !skip }, rest));
};
