...
export const useAddChild = ({ parentId, childId, data }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKNestableMultiAssetImpl, functionName: 'addChild', args: [parentId, childId, data] }, rest));
