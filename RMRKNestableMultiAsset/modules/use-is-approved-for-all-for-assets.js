...
const createMapper = ({ chainId, contractAddress, }) => function mapIsApprovedForAllForAssetsArgs({ owner, operator, }) {
    return {
...
export const useIsApprovedForAllForAssets = (args, _a) => {
...
//# sourceMappingURL=use-is-approved-for-all-for-assets.js.map