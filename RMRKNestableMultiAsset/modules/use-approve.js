...
export const useApprove = ({ to, tokenId }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKNestableMultiAssetImpl, functionName: 'approve', args: [to, tokenId] }, rest));
