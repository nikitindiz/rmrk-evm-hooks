...
export const useTransferFrom = ({ from, to, tokenId }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKNestableMultiAssetImpl, functionName: 'transferFrom', args: [from, to, tokenId] }, rest));
