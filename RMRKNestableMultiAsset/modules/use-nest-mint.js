...
export const useNestMint = ({ to, numToMint, destinationId }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKNestableMultiAssetImpl, functionName: 'nestMint', args: [to, numToMint, destinationId] }, rest));
