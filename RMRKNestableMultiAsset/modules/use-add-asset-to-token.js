...
export const useAddAssetToToken = ({ tokenId, assetId, replacesAssetWithId }, _a) => {
    var { chainId, contractAddress, signer } = _a, rest = __rest(_a, ["chainId", "contractAddress", "signer"]);
    const [receipt, setReceipt] = useState();
    const [waitError, setWaitError] = useState();
    const [isWaiting, setIsWaiting] = useState();
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKNestableMultiAssetImpl, functionName: 'addAssetToToken', args: [tokenId, assetId, replacesAssetWithId] }, rest));
...
//# sourceMappingURL=use-add-asset-to-token.js.map