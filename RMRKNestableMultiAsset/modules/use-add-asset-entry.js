...
export const useAddAssetEntry = ({ metadataURI }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKNestableMultiAssetImpl, functionName: 'addAssetEntry', args: [metadataURI] }, rest));
...
//# sourceMappingURL=use-add-asset-entry.js.map