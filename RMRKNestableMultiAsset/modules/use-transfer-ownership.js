...
export const useTransferOwnership = ({ newOwner }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKNestableMultiAssetImpl, functionName: 'transferOwnership', args: [newOwner] }, rest));
