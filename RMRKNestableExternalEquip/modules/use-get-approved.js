...
const createMapper = ({ chainId, contractAddress, }) => function mapGetApprovedArgs({ tokenId }) {
    return {
...
export const useGetApproved = (args, _a) => {
...
//# sourceMappingURL=use-get-approved.js.map