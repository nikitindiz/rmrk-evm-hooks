...
export const useTransferChild = ({ tokenId, to, destinationId, childIndex, childAddress, childId, isPending, data, }, _a) => {
    var { chainId, contractAddress, signer } = _a, rest = __rest(_a, ["chainId", "contractAddress", "signer"]);
    const [receipt, setReceipt] = useState();
    const [waitError, setWaitError] = useState();
    const [isWaiting, setIsWaiting] = useState();
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKNestableExternalEquipImpl, functionName: 'transferChild', args: [tokenId, to, destinationId, childIndex, childAddress, childId, isPending, data] }, rest));
...
//# sourceMappingURL=use-transfer-child.js.map