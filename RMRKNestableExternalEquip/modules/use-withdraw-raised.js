...
export const useWithdrawRaised = ({ to, amount }, _a) => {
    ...
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKNestableExternalEquipImpl, functionName: 'withdrawRaised', args: [to, amount] }, rest));
