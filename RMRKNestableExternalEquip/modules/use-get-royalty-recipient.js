...
export const useGetRoyaltyRecipient = (_a) => {
    ...
    return useContractRead(Object.assign({ address: contractAddress, abi: RMRKNestableExternalEquipImpl, functionName: 'getRoyaltyRecipient', chainId, enabled: !skip }, rest));
};
