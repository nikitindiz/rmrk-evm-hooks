...
export const useRejectAllChildren = ({ tokenId, maxRejections }, _a) => {
    var { chainId, contractAddress, signer } = _a, rest = __rest(_a, ["chainId", "contractAddress", "signer"]);
    const [receipt, setReceipt] = useState();
    const [waitError, setWaitError] = useState();
    const [isWaiting, setIsWaiting] = useState();
    const prepare = usePrepareContractWrite(Object.assign({ address: contractAddress, chainId, abi: RMRKNestableExternalEquipImpl, functionName: 'rejectAllChildren', args: [tokenId, maxRejections] }, rest));
...
//# sourceMappingURL=use-reject-all-children.js.map