...
const availableMintTokenWithAssetNetworks = {
    'moonbase-alpha': '0x9D2F9635014d9B400C22B30693eed09Bb0585Ef4',
};
export const useMintTokenWithAsset = ({ collection, asset, to }, _a) => {
    var { chainId, network, signer } = _a, rest = __rest(_a, ["chainId", "network", "signer"]);
    const [receipt, setReceipt] = useState();
    const [waitError, setWaitError] = useState();
    const [isWaiting, setIsWaiting] = useState();
    const prepare = usePrepareContractWrite(Object.assign({ address: availableMintTokenWithAssetNetworks[network], chainId, abi: MetaFactoryAbi, functionName: 'mintTokenWithAsset', args: [collection, asset, to] }, rest));
    ...
    const contract = getContract({
        address: availableMintTokenWithAssetNetworks[network],
        abi: MetaFactoryAbi,
...
//# sourceMappingURL=use-mint-token-with-asset.js.map